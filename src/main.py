...
def main() -> int:
    ...
    parser.add_argument(
        "--internal",
        action="store_true",
        help="Generate internal detailed report with resource-level costs",
    )
    parser.add_argument(
        "--console-only",
        action="store_true",
    ...
    try:
        ...
        if config["report"]["mask_account_ids"] and not args.internal:
        ...
        if args.internal:
            ...
            if args.console_only:
                ...
                report_path = internal_generator.generate_detailed_report(
                    title="AWS Internal Cost Analysis",
                    summary=summary,
                    detailed_costs=detailed_costs,
                    tag_costs=tag_costs,
                    days_back=days_back,
            ...
            logger.info(f"✅ Public report generated: {report_path}")
