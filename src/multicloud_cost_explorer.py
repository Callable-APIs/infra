...
class MultiCloudCostExplorer:
                ...
                "costs": [
                    {
                        ...
                        "Groups": [
                            {"Keys": ["Compute Engine"], "Metrics": {"BlendedCost": {"Amount": "0.00", "Unit": "USD"}}}
                        ],
                    }
                ],
                "total_cost": 0.0,
                ...
                "costs": [
                    {
                        ...
                        "Total": {"BlendedCost": {"Amount": "0.00", "Unit": "USD"}},
                        "Groups": [
                            {"Keys": ["Compute"], "Metrics": {"BlendedCost": {"Amount": "0.00", "Unit": "USD"}}}
                        ],
                    }
                ],
                "total_cost": 0.0,
                ...
                "costs": [
                    {
                        ...
                        "Total": {"BlendedCost": {"Amount": "0.00", "Unit": "USD"}},
                        "Groups": [
                            {"Keys": ["Virtual Servers"], "Metrics": {"BlendedCost": {"Amount": "0.00", "Unit": "USD"}}}
                        ],
                    }
                ],
                "total_cost": 0.0,
    ...
    def get_all_costs(self, days_back: int = 30) -> Dict[str, Any]:
        ...
        return {
            ...
            "providers": {"aws": aws_costs, "google": google_costs, "oracle": oracle_costs, "ibm": ibm_costs},
...
- Google Cloud: 1x e2-micro (1 vCPU, 1GB RAM) - google.callableapis.com
