...
# IBM Cloud VSI Instance Setup Script
...
echo "IBM Cloud VSI instance setup complete - $(date)" > /home/ubuntu/setup.log
echo "IBM Cloud VSI instance setup complete - $(date)" > /home/ansible/setup.log
