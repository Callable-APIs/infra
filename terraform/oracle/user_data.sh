...
# Oracle Cloud ARM Instance Setup Script
...
echo "Oracle Cloud ARM instance setup complete - $(date)" > /home/ubuntu/setup.log
echo "Oracle Cloud ARM instance setup complete - $(date)" > /home/ansible/setup.log
